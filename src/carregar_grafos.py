...
def carregar_grafo(caminho): # Criar a função para carregar o .pkl
    if Path(caminho).exists():# verifica se o arquivo já existe na pasta
        ...
        return baixar_grafo(caminho) # Caso contrário, ele baixa.



if __name__ == '__main__':
    caminho = "data/raw/rj_grafo.pkl"  #definir o caminho no qual o arquivo está
    grafo_rj = carregar_grafo(caminho) #atribui a variavel grafo_rj ao carregar o arquivo
